 ...
 * @author xiaoxiao
 */
public class ScrollForStrengtheningWBJ1 extends ItemExecutor {

    public static ItemExecutor get() {
        return new ScrollForStrengtheningWBJ1();
    }

    private ScrollForStrengtheningWBJ1() {
    }
    ...
    public void execute(final int[] data, final L1PcInstance pc,
        ...
        final short skillId = L1SkillId.EFFECT_STRENGTHENING_WBJ8;        
