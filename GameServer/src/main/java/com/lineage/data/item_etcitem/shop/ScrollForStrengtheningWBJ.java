 ...
 * @author xiaoxiao
 */
public class ScrollForStrengtheningWBJ extends ItemExecutor {

    public static ItemExecutor get() {
        return new ScrollForStrengtheningWBJ();
    }

    private ScrollForStrengtheningWBJ() {
    }
    ...
    public void execute(final int[] data, final L1PcInstance pc,
        ...
        final short skillId = L1SkillId.EFFECT_STRENGTHENING_WBJ6;        
