 ...
 * @author xiaoxiao
 */
public class ScrollForStrengtheningWBJ2 extends ItemExecutor {

    public static ItemExecutor get() {
        return new ScrollForStrengtheningWBJ2();
    }

    private ScrollForStrengtheningWBJ2() {
    }
    ...
    public void execute(final int[] data, final L1PcInstance pc,
        ...
        final short skillId = L1SkillId.EFFECT_STRENGTHENING_WBJ10;        
