...
/**
 * 自定義傳送符 傳送點設置在etcitem_teleport內 本物件使用後不會被刪除 classname: teleport.SOR_UserSet2
 * 設置範例: teleport.SOR_UserSet2
 * 
 * @author dexc
 * 
 */
public class SOR_UserSet3 extends ItemExecutor {

    private static final Log _log = LogFactory.getLog(SOR_UserSet3.class);

    /**
     *
     */
    private SOR_UserSet3() {
        // TODO Auto-generated constructor stub
    }

    public static ItemExecutor get() {
        return new SOR_UserSet3();
    }
