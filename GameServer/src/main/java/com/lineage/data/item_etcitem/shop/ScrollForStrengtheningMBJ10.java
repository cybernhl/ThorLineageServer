 ...
 * @author xiaoxiao
 */
public class ScrollForStrengtheningMBJ10 extends ItemExecutor {

    public static ItemExecutor get() {
        return new ScrollForStrengtheningMBJ10();
    }

    private ScrollForStrengtheningMBJ10() {
    }
    ...
    public void execute(final int[] data, final L1PcInstance pc,
        ...
        final short skillId = L1SkillId.EFFECT_STRENGTHENING_MBJ10;        
        
        if(pc.hasSkillEffect(L1SkillId.EFFECT_STRENGTHENING_MBJ10)){
			pc.sendPackets(new S_ServerMessage("需等待10%魔法暴擊效果"+pc.getSkillEffectTimeSec(L1SkillId.EFFECT_STRENGTHENING_MBJ10)+"秒才可使用"));
			return;
		}
