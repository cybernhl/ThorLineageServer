...
/**
 * <font color=#00800>金之武器強化卷軸</font><BR>
 *
 * @see 增加武器 強化值<BR>
 * @author dexc
 *
 */
public class ScrollEnchantGoldWeapon extends ItemExecutor {

	/**
	 *
	 */
	private ScrollEnchantGoldWeapon() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new ScrollEnchantGoldWeapon();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		final int newAttrEnchantKind = 256;// 金
		boolean isErr = false;
