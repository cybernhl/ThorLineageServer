...
/**
 * <font color=#00800>木之武器強化卷軸</font><BR>
 *
 * @see 增加武器 強化值<BR>
 * @author dexc
 *
 */
public class ScrollEnchantWoodWeapon extends ItemExecutor {

	/**
	 *
	 */
	private ScrollEnchantWoodWeapon() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new ScrollEnchantWoodWeapon();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		final int newAttrEnchantKind = 512;// 木
		boolean isErr = false;
