...
public class Skill_SpiritCrystal_Earth extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (!pc.isElf()) {
			...
			if (nameId.equalsIgnoreCase("精靈水晶(大地防護)")) {// 精靈水晶(大地防護)
				// 技能編號
				skillid = EARTH_SKIN;
				// 分組
				magicLv = 13;

			} else if (nameId.equalsIgnoreCase("精靈水晶(地面障礙)")) {// 精靈水晶(地面障礙)
				// 技能編號
				skillid = ENTANGLE;
				// 分組
				magicLv = 13;

			} else if (nameId.equalsIgnoreCase("精靈水晶(大地屏障)")) {// 精靈水晶(大地屏障)
				// 技能編號
				skillid = EARTH_BIND;
				// 分組
				magicLv = 14;

			} else if (nameId.equalsIgnoreCase("精靈水晶(大地的祝福)")) {// 精靈水晶(大地的祝福)
				// 技能編號
				skillid = EARTH_BLESS;
				// 分組
				magicLv = 14;

			} else if (nameId.equalsIgnoreCase("精靈水晶(鋼鐵防護)")) {// 精靈水晶(鋼鐵防護)
				// 技能編號
				skillid = IRON_SKIN;
				// 分組
				magicLv = 15;

			} else if (nameId.equalsIgnoreCase("精靈水晶(體能激發)")) {// 精靈水晶(體能激發)
				// 技能編號
