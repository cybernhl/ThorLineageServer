...
public class L1NpcXmlParser {
	...
	public static Element getFirstChildElementByTagName(final Element element,
		...
		final IterableElementList list = new IterableElementList(element
	...
	public static boolean getBoolAttribute(final Element element, final String name,
	...
	static {
		...
		_questIds.put("ruba", L1PcQuest.QUEST_RUBA);
		_questIds.put("lukein", L1PcQuest.QUEST_LUKEIN1);
		_questIds.put("tbox1", L1PcQuest.QUEST_TBOX1);
		_questIds.put("tbox2", L1PcQuest.QUEST_TBOX2);
		_questIds.put("tbox3", L1PcQuest.QUEST_TBOX3);
		_questIds.put("cadmus", L1PcQuest.QUEST_CADMUS);
		_questIds.put("resta", L1PcQuest.QUEST_RESTA);
		_questIds.put("kamyla", L1PcQuest.QUEST_KAMYLA);
		_questIds.put("lizard", L1PcQuest.QUEST_LIZARD);
		_questIds.put("desire", L1PcQuest.QUEST_DESIRE);
		_questIds.put("shadows", L1PcQuest.QUEST_SHADOWS);
		_questIds.put("toscroll", L1PcQuest.QUEST_TOSCROLL);
		_questIds.put("moonoflongbow", L1PcQuest.QUEST_MOONOFLONGBOW);
		_questIds.put("Generalhamelofresentment", L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT);*/
	}
