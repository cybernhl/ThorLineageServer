...
/**
 * NPC物品販賣<br>
 * 類名稱：S_ShopSellList<br>
 * 創建人:Warrior<br>
 * 修改時間：2017年9月9日 下午1:31:57<br>
 * 修改人:QQ:759347094<br>
 * 修改備註:更新182<br>
 * @version<br>
 */
public class S_ShopSellList extends ServerBasePacket {
	...
	public S_ShopSellList(final int objId) {
		...
		for (int i = 0; i < shopItems.size(); i++) {
			...
			final int price = ConfigRate.RATE_SHOP_SWITCH ? calc.layTax((int) (shopItem.getPrice() * ConfigRate.RATE_SHOP_SELLING_PRICE)) : shopItem.getPrice();
			this.writeD(i);// 排序
